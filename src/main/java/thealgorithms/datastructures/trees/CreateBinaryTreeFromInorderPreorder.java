package thealgorithms.datastructures.trees;
...
public class CreateBinaryTreeFromInorderPreorder {
    ...
    private static BinaryTree.Node createTree(final Integer[] preorder, final Integer[] inorder,
                                              final int preStart, final int inStart, final int size) {
        if (size == 0) {
            return null;
        }

        BinaryTree.Node root = new BinaryTree.Node(preorder[preStart]);
        int i = inStart;
    ...
    private static BinaryTree.Node createTreeOptimized(final Integer[] preorder, final Integer[] inorder,
                                                       final int preStart, final int inStart, final int size,
